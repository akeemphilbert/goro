...
func TestNewContainer(t *testing.T) {
	...
	container := NewContainer(ctx, "test-container-1", "parent-container", BasicContainer)
...
func TestNewContainer_AutoGeneratedID(t *testing.T) {
	ctx := context.Background()
	container := NewContainer(ctx, "", "parent-container", BasicContainer)
...
func TestNewContainer_RootContainer(t *testing.T) {
	ctx := context.Background()
	container := NewContainer(ctx, "root", "", BasicContainer)
...
func TestContainer_AddMember(t *testing.T) {
	...
	resource := NewResource(ctx, "resource-1", "text/plain", []byte("test data"))
...
func TestContainer_AddMember_NilResource(t *testing.T) {
	...
	err := container.AddMember(ctx, nil)
	assert.Error(t, err)
...
func TestContainer_RemoveMember(t *testing.T) {
	...
	err = container.RemoveMember(ctx, "resource-1")
	assert.NoError(t, err)
...
func TestContainer_RemoveMember_EmptyID(t *testing.T) {
	...
	err := container.RemoveMember(ctx, "")
	assert.Error(t, err)
...
func TestContainer_ValidateHierarchy_CircularReference(t *testing.T) {
	ctx := context.Background()
	container := NewContainer(ctx, "container-1", "container-2", BasicContainer)
...
func TestContainer_ValidateHierarchy_SelfReference(t *testing.T) {
	ctx := context.Background()
	container := NewContainer(ctx, "container-1", "container-1", BasicContainer)
...
func TestContainer_GetPath(t *testing.T) {
	ctx := context.Background()
	container := NewContainer(ctx, "test-container", "parent-container", BasicContainer)
